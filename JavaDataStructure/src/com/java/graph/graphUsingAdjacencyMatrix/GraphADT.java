 ...
 * Vertex class  
 * @author chetan
 * It is not a good implementation. Very very bad implementation, bcz edges are denoting by AdjMatrix
 * and vertex are denoting using Vertex class.
 *
 * Here instead of AdjMatrix, we should use Edge class which contains source, destination and weight.
 */
